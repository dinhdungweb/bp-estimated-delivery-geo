...
export const WIDGET_TEMPLATES: TemplateMeta[] = [
  ...
  {
    name: "Holiday Delivery Window",
    description: "Festive holiday delivery timeline.",
  ...
  {
    name: "Summer Fresh Shipping",
    description: "Bright and breezy summer ETA.",
  ...
  {
    name: "Black Friday ETA",
    description: "Bold Black Friday delivery countdown.",
    style: "orange_blitz",
    category: "Seasonal",
    discount: "61% off",
    badgeTone: "amber",
  ...
  {
    name: "Valentine Gift ETA",
    description: "Sweet and romantic delivery tracker.",
  ...
  },
  {
    ...
    description: "Celebrate with on-time delivery.",
    style: "seasonal_new_year_delivery",
    category: "Seasonal",
    discount: "62% off",
    badgeTone: "amber",
  },
  {
    name: "Spring Sale ETA",
    description: "Fresh, floral spring delivery updates.",
  ...
  {
    name: "Halloween Shipping",
    description: "Spooky-season delivery tracker.",
    style: "seasonal_halloween_shipping",
    category: "Seasonal",
    discount: "59% off",
    badgeTone: "slate",
  },
  {
    name: "Gift Ready",
    description: "Clean and classic gift delivery tracker.",
    style: "seasonal_gift_ready",
    category: "Seasonal",
    discount: "64% off",
    badgeTone: "green",
  },
